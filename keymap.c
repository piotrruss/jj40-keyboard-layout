...
[_LOWER] = LAYOUT_ortho_4x12( \
  KC_MSTP, _______,  _______,  KC_LPRN,  KC_RPRN,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS, \
 ...
 * | Shift|   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  |   -  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |      | Alt  | GUI  |Lower |      |      |Raise |      |      |      |   _  |  
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_ortho_4x12( \
  S(KC_GRAVE), KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_EQL, \
  ...
  KC_LCTL,    _______, KC_LALT, KC_LGUI, _______, _______, _______, _______, _______, _______, _______, KC_UNDS  \
)
};
